...
import { IInputEmail, IInputMobile, IInputName, IInputPassword, IInputText, IInputTextarea } from './inputs';

export type NgxFormInputs = IInputEmail | IInputMobile | IInputName | IInputPassword | IInputText | IInputTextarea;
